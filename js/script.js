...
function getMovies(searchText){
  ...
  axios.get('http://www.omdbapi.com/?s='+searchText+'&apikey=2e2f1a7d')
    ...
    .then((response) => {
      ...
      if(response.data.Response === 'False'){
        alert('No Movie Found with this Name!!');
      }
      let output = '';
...
function getMovie(){
  ...
  axios.get('http://www.omdbapi.com/?i='+movieId+'&apikey=2e2f1a7d')
